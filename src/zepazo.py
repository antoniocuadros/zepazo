...
parser.add_argument( "-sf", "--startingFrame", type=int, help="Number of frame from which to start the analysis")
parser.add_argument( "-ef", "--endingFrame", type=int, help="Frame number up to which to analyze")
