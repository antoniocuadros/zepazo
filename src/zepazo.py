...
parser.add_argument( "-sf", "--startingFrame", type=str, help="Number of frame from which to start the analysis")
parser.add_argument( "-ef", "--endingFrame", type=str, help="Frame number up to which to analyze")
