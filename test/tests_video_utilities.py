...
def test_if_object_is_created_ok():
    video_analizer = VideoAnalyzer('test/example_video/test.mp4', 'False', None, None, None, None, None)
...
def test_if_object_is_created_with_error():
    with pytest.raises(Exception) as e:
        video_analiyzer = VideoAnalyzer('test/example_video/test5.mp4', 'False', None, None, None, None, None)
...
def test_if_current_time_ok():
    video_analyzer = VideoAnalyzer('test/example_video/test.mp4', 'False', None, None, None, None, None)
...
def test_if_video_shows():
    video_analyzer = VideoAnalyzer('test/example_video/test.mp4', 'True', None, None, None, None, None)
    cap = video_analyzer.videoCapture
